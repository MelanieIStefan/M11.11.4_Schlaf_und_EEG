...
{ \usebackgroundtemplate{\includegraphics[width=\paperwidth]{EEG_gesund.pdf}} 
\begin{frame}
...
Das evozierte EEG-Signal (\(1–15\,\micro V\)) hat eine viel kleiner Amplitude als das Hintergrund-EEG (\(50–100\,\micro V\)). \pause \textcolor{theme}{Wie können wir es trotzdem sehen?} 
...
Das evozierte EEG-Signal (\(1–15\,\micro V\)) hat eine viel kleiner Amplitude als das Hintergrund-EEG (\(50–100\,\micro V\)).  \\
Wir müssen oft (50 Mal plus) messen und mitteln!

    
\end{frame}

\begin{frame}{Beispiel: Akustisch evoziertes Potential}
    
\end{frame}

\begin{frame}{Beispiel: Somatisch evoziertes Potential}
