...
\begin{center}
    \includegraphics[width=\textwidth]{fourier_alpha.png}
\end{center}
...
\begin{frame}{Der Nucleus Suprachiasmaticus ist der Schrittmacher für den zirkadianen Rhythmus}
    ...
    Der SCN signalisiert in andere Teile des Hypothalamus, Hypophyse, Zirbeldrüse, Seputm, Hirnstamm, Rückenmark, Blutbahn  \\[9.5 cm]
...
\begin{center}
    \includegraphics[0.8\textwidth]{Hypno_zyklus.png}
\end{center}
