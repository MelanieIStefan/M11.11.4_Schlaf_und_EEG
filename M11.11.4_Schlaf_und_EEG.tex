...
\begin{center}
    \includegraphics[width=0.8\textwidth]{fourier_alpha.png}
\end{center}
...
{ \usebackgroundtemplate{\includegraphics[width=1.2\paperwidth]{EEG_gesund.pdf}} 
\begin{frame}
...
\begin{frame}{N1: Leichter Schlaf}
    ...
    \begin{center}
            \includegraphics[width=\textwidth]{Sleep_EEG_Stage_1.jpg}
...
\begin{frame}{N2: Mitteltiefer Schlaf}
    ...
    \begin{center}
            \includegraphics[width=\textwidth]{Sleep_EEG_Stage_2.jpg}
...
\begin{frame}{N3: Tiefschlaf}
    ...
    \begin{center}
            \includegraphics[width=\textwidth]{Sleep_EEG_Stage_4.jpg}
...
EEG ähnlich wie bei Wachheit oder leichtem Schlaf. Schnelle Bewegungen der Augenmuskeln
    ...
    \begin{center}
            \includegraphics[width=\textwidth]{Sleep_EEG_REM.png}
...
% \begin{itemize}
%     \item 
%     Gelegenheitsanfälle sind relativ häaufig (Bis zu \(10\,\%\) erleben einmal im Leben einen Anfall)
%     \item
%     Genetische Faktoren 
%     \item
%     Hirnsch
...
\item
Verschiedene Wellenformen im EEG. Modifiziert nach Laurens R. Krol, CC0, via Wikimedia Commons 
